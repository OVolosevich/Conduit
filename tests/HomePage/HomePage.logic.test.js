import { getArticles } from "../../src/pages/HomePage/services";
import * as fetch from "node-fetch";
//const fetch = require("node-fetch");

describe("getArticles async fn", () => {
  test("returns articles array", async () => {
    ...
    data.then((res) => expect(res).toEqual(expectedResponse));
  });
});
